# NexI Self-Hosting Guide

This guide provides detailed instructions for setting up and hosting your own instance of NexI, an open-source generalist AI agent.
...
- Start NexI using your preferred method
...
NexI can be started in two ways:
...
For further assistance, join the [NexI Discord Community](https://discord.gg/Py6pCBUUPw) or check the [GitHub repository](https://github.com/nexi-ai/NexI) for updates and issues.
